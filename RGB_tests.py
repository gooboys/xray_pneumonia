...
from RGBModels import denseA3, denseB5, eff3, eff4, denseA, mobileV22, mobileV24
...
if __name__ == "__main__":
    ...
    models = [eff3, eff4, denseA3, denseB5, denseA, mobileV22, mobileV24]

    # List of model names as strings
    model_names = ['eff3', 'eff4', 'denseA3', 'denseB5', 'denseA', 'mobileV22', 'mobileV24']
    # models = [denseA5]
    # model_names = ["denseA5"]

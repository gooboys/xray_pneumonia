...
class tDenseA5(nn.Module):
    def __init__(self, dropout_rate=0.5, freeze_base=True, l2_weight_decay=1e-4):
        ...
        self.fc1 = nn.Linear(1024, 128)  # DenseNet-121 output channels = 1024
...
model = tDenseA5(dropout_rate=0.5, freeze_base=True)

...
class denseB3(nn.Module):
    def __init__(self):
        super(denseB3, self).__init__()
        ...
        self.densenet.classifier = nn.Linear(1664, 416)  # DenseNet-169 has 1664 output features
        self.dropout1 = nn.Dropout(p=0.5)
        self.fc1 = nn.Linear(416,104)
        self.dropout2 = nn.Dropout(p=0.5)
        self.fc2 = nn.Linear(104, 2)
